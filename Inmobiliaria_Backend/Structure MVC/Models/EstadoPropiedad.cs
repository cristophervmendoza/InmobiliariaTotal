...
namespace backend_csharpcd_inmo.Structure_MVC.Models
{
    ...
    public class EstadoPropiedad : IValidatableObject
    {
        [Key]
        [Column("idEstadoPropiedad")]
        ...
        [InverseProperty("EstadoPropiedad")]
        ...
        public System.Collections.Generic.IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            if (!string.IsNullOrEmpty(Nombre))
            {
                ...
                {
                    yield return new ValidationResult("El estado de la propiedad no es válido. Estados permitidos: Disponible, Vendida, Alquilada, Reservada, En Proceso, Retirada, Mantenimiento, Pendiente, Suspendida, Archivada", new[] { nameof(Nombre) });
                }
            ...
            {
                yield return new ValidationResult("Los estados de propiedad son datos de catálogo que deberían existir desde el inicio del sistema", new[] { nameof(CreadoAt) });
            }
